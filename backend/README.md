...
```text
http://120.46.136.60.sslip.io:8080/api/cosod
```
...
```bash
curl http://120.46.136.60.sslip.io:8080/api/health
```
...
```text
/api/cosod -> http://120.46.136.60.sslip.io:8080/api/cosod
/outputs/* -> http://120.46.136.60.sslip.io:8080/outputs/*
```
